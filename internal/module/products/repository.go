...
func NewPostgresDatabase(db *sqlx.DB) *PostgresRepository {
...
// Update updates a product and returns the stored row.
...
// Delete soft-deletes an active product.
...
func (r *PostgresRepository) queryProducts(ctx context.Context, query string, args ...any) ([]Product, error) {
	if err := ctx.Err(); err != nil {
		return nil, err
	}
